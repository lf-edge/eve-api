...
type EdgeNodeCluster struct {
	...
	// URL to download a yaml manifest for a cluster
	// These manifests should not define app-instance deployments.
	EncryptedManifestYamlUrl *evecommon.CipherBlock `protobuf:"bytes,8,opt,name=encrypted_manifest_yaml_url,json=encryptedManifestYamlUrl,proto3" json:"encrypted_manifest_yaml_url,omitempty"`
}
...
func (x *EdgeNodeCluster) GetEncryptedManifestYamlUrl() *evecommon.CipherBlock {
	if x != nil {
		return x.EncryptedManifestYamlUrl
	}
	return nil
}
...
var file_config_edge_node_cluster_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb7, 0x03, 0x0a, 0x0f, 0x45, 0x64, 0x67, 0x65, 0x4e, 0x6f, 0x64,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x61, 0x0a, 0x1b, 0x65,
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x5f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73,
	0x74, 0x5f, 0x79, 0x61, 0x6d, 0x6c, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76,
	0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x69, 0x70, 0x68, 0x65, 0x72, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x18, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d,
	0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x59, 0x61, 0x6d, 0x6c, 0x55, 0x72, 0x6c, 0x42, 0x3d,
...
var file_config_edge_node_cluster_proto_depIdxs = []int32{
	...
	1, // 1: org.lfedge.eve.config.EdgeNodeCluster.encrypted_manifest_yaml_url:type_name -> org.lfedge.eve.common.CipherBlock
