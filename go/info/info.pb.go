...
// How a vault was unlocked on the current boot. DataSecAtRestStatus cannot
// express this: a clean local unseal, a recovery that needed the controller's
// escrowed key, and a wipe-and-recreate that lost the vault's prior contents
// all end up reported as enabled.
// Must match the values in pkg/pillar/types.VaultUnlockMethod.
type VaultUnlockMethod int32

const (
	VaultUnlockMethod_VAULT_UNLOCK_METHOD_UNSPECIFIED      VaultUnlockMethod = 0 // Not reported, or not yet unlocked
	VaultUnlockMethod_VAULT_UNLOCK_METHOD_TPM_LOCAL_SEALED VaultUnlockMethod = 1 // Sealed key unsealed against the current PCRs
	VaultUnlockMethod_VAULT_UNLOCK_METHOD_CONTROLLER_KEY   VaultUnlockMethod = 2 // Local unseal failed; the escrowed key was used
	VaultUnlockMethod_VAULT_UNLOCK_METHOD_NO_TPM           VaultUnlockMethod = 3 // Platform has no TPM; the key is not sealed
	VaultUnlockMethod_VAULT_UNLOCK_METHOD_RECREATED        VaultUnlockMethod = 4 // Nothing unlocked it; wiped and recreated empty
)

// Enum value maps for VaultUnlockMethod.
var (
	VaultUnlockMethod_name = map[int32]string{
		0: "VAULT_UNLOCK_METHOD_UNSPECIFIED",
		1: "VAULT_UNLOCK_METHOD_TPM_LOCAL_SEALED",
		2: "VAULT_UNLOCK_METHOD_CONTROLLER_KEY",
		3: "VAULT_UNLOCK_METHOD_NO_TPM",
		4: "VAULT_UNLOCK_METHOD_RECREATED",
	}
	VaultUnlockMethod_value = map[string]int32{
		"VAULT_UNLOCK_METHOD_UNSPECIFIED":      0,
		"VAULT_UNLOCK_METHOD_TPM_LOCAL_SEALED": 1,
		"VAULT_UNLOCK_METHOD_CONTROLLER_KEY":   2,
		"VAULT_UNLOCK_METHOD_NO_TPM":           3,
		"VAULT_UNLOCK_METHOD_RECREATED":        4,
	}
)

func (x VaultUnlockMethod) Enum() *VaultUnlockMethod {
	p := new(VaultUnlockMethod)
	*p = x
	return p
}

func (x VaultUnlockMethod) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VaultUnlockMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[6].Descriptor()
}

func (VaultUnlockMethod) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[6]
}

func (x VaultUnlockMethod) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VaultUnlockMethod.Descriptor instead.
func (VaultUnlockMethod) EnumDescriptor() ([]byte, []int) {
	return file_info_info_proto_rawDescGZIP(), []int{6}
}

// How a vault's key is derived. A vault created before EVE 7.10.0 keeps
// deriving its key by merging the TPM key with a fixed constant, so only half
// of the 32 bytes comes from the TPM. The mode is decided once, the first time
// a TPM-enabled device runs a release that records it, and never revisited.
// Devices without a TPM derive no vault key and leave this unspecified.
type VaultKeyDerivation int32

const (
	VaultKeyDerivation_VAULT_KEY_DERIVATION_UNSPECIFIED      VaultKeyDerivation = 0 // Not reported, or no TPM
	VaultKeyDerivation_VAULT_KEY_DERIVATION_TPM_ONLY         VaultKeyDerivation = 1 // TPM key alone
	VaultKeyDerivation_VAULT_KEY_DERIVATION_TPM_AND_CONSTANT VaultKeyDerivation = 2 // TPM key merged with a fixed constant
)

// Enum value maps for VaultKeyDerivation.
var (
	VaultKeyDerivation_name = map[int32]string{
		0: "VAULT_KEY_DERIVATION_UNSPECIFIED",
		1: "VAULT_KEY_DERIVATION_TPM_ONLY",
		2: "VAULT_KEY_DERIVATION_TPM_AND_CONSTANT",
	}
	VaultKeyDerivation_value = map[string]int32{
		"VAULT_KEY_DERIVATION_UNSPECIFIED":      0,
		"VAULT_KEY_DERIVATION_TPM_ONLY":         1,
		"VAULT_KEY_DERIVATION_TPM_AND_CONSTANT": 2,
	}
)

func (x VaultKeyDerivation) Enum() *VaultKeyDerivation {
	p := new(VaultKeyDerivation)
	*p = x
	return p
}

func (x VaultKeyDerivation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VaultKeyDerivation) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[7].Descriptor()
}

func (VaultKeyDerivation) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[7]
}

func (x VaultKeyDerivation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VaultKeyDerivation.Descriptor instead.
func (VaultKeyDerivation) EnumDescriptor() ([]byte, []int) {
...
type VaultInfo struct {
	...
	UnlockMethod  VaultUnlockMethod   `protobuf:"varint,5,opt,name=unlock_method,json=unlockMethod,proto3,enum=org.lfedge.eve.info.VaultUnlockMethod" json:"unlock_method,omitempty"`     //How the vault was unlocked this boot
	KeyDerivation VaultKeyDerivation  `protobuf:"varint,6,opt,name=key_derivation,json=keyDerivation,proto3,enum=org.lfedge.eve.info.VaultKeyDerivation" json:"key_derivation,omitempty"` //How the vault key is derived
}
...
func (x *VaultInfo) GetUnlockMethod() VaultUnlockMethod {
	if x != nil {
		return x.UnlockMethod
	}
	return VaultUnlockMethod_VAULT_UNLOCK_METHOD_UNSPECIFIED
}

func (x *VaultInfo) GetKeyDerivation() VaultKeyDerivation {
	if x != nil {
		return x.KeyDerivation
	}
	return VaultKeyDerivation_VAULT_KEY_DERIVATION_UNSPECIFIED
}
...
var file_info_info_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0xf8, 0x02, 0x0a, 0x09, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x49, 0x6e, 0x66,
	...
	0x73, 0x12, 0x4b, 0x0a, 0x0d, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c,
	0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x56,
	0x61, 0x75, 0x6c, 0x74, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64,
	0x52, 0x0c, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x4e,
	0x0a, 0x0e, 0x6b, 0x65, 0x79, 0x5f, 0x64, 0x65, 0x72, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6c, 0x74, 0x4b, 0x65, 0x79, 0x44, 0x65, 0x72, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0d, 0x6b, 0x65, 0x79, 0x44, 0x65, 0x72, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa3,
	...
	0x22, 0xa3, 0x18, 0x0a, 0x0b, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x41, 0x0a, 0x09, 0x73,
	0x75, 0x62, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x3d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24,
	0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e,
	0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x5a, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53, 0x75, 0x62, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x52, 0x08, 0x73, 0x75, 0x62, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x23,
	...
	,
	...
	0x4f, 0x54, 0x4f, 0x43, 0x4f, 0x4c, 0x5f, 0x4d, 0x42, 0x49, 0x4d, 0x10, 0x02, 0x2a, 0xcf, 0x02,
	...
	,
	...
	0x50, 0x45, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x5f, 0x5a, 0x46, 0x53, 0x10, 0x02, 0x2a, 0xb2, 0x07,
	...
	,
	...
	0x0e, 0x12, 0x1f, 0x0a, 0x1b, 0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x52, 0x45, 0x41, 0x53, 0x4f, 0x4e,
	0x5f, 0x4b, 0x55, 0x42, 0x45, 0x5f, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e,
	0x10, 0x0f, 0x12, 0x1b, 0x0a, 0x17, 0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x52, 0x45, 0x41, 0x53, 0x4f,
	0x4e, 0x5f, 0x48, 0x57, 0x5f, 0x57, 0x41, 0x54, 0x43, 0x48, 0x44, 0x4f, 0x47, 0x10, 0x10, 0x12,
...
var file_info_info_proto_goTypes = []interface{}{
	...
	(VaultUnlockMethod)(0),               // 6: org.lfedge.eve.info.VaultUnlockMethod
	(VaultKeyDerivation)(0),              // 7: org.lfedge.eve.info.VaultKeyDerivation
	...
	(ZDeviceSubState)(0),                 // 12: org.lfedge.eve.info.ZDeviceSubState
	(StorageStatus)(0),                   // 13: org.lfedge.eve.info.StorageStatus
	(StorageRaidType)(0),                 // 14: org.lfedge.eve.info.StorageRaidType
	(StorageTypeInfo)(0),                 // 15: org.lfedge.eve.info.StorageTypeInfo
	(APICapability)(0),                   // 16: org.lfedge.eve.info.APICapability
	(BootReason)(0),                      // 17: org.lfedge.eve.info.BootReason
	(MaintenanceModeReason)(0),           // 18: org.lfedge.eve.info.MaintenanceModeReason
	(AttestationState)(0),                // 19: org.lfedge.eve.info.AttestationState
	(AppInstMetaDataType)(0),             // 20: org.lfedge.eve.info.AppInstMetaDataType
